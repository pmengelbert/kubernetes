...
func (in AttestationClaimValue) DeepCopyInto(out *AttestationClaimValue) {
	{
		in := &in
		*out = make(AttestationClaimValue, len(*in))
		copy(*out, *in)
		return
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AttestationClaimValue.
func (in AttestationClaimValue) DeepCopy() AttestationClaimValue {
	if in == nil {
		return nil
	}
	out := new(AttestationClaimValue)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *TokenRequestSpec) DeepCopyInto(out *TokenRequestSpec) {
	*out = *in
	...
	if in.Attestations != nil {
		...
		*out = make(map[string]AttestationClaimValue, len(*in))
