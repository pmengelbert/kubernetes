...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*AllowlistItem)(nil), (*config.AllowlistItem)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_AllowlistItem_To_config_AllowlistItem(a.(*AllowlistItem), b.(*config.AllowlistItem), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.AllowlistItem)(nil), (*AllowlistItem)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_AllowlistItem_To_v1alpha1_AllowlistItem(a.(*config.AllowlistItem), b.(*AllowlistItem), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_AllowlistItem_To_config_AllowlistItem(in *AllowlistItem, out *config.AllowlistItem, s conversion.Scope) error {
	out.Name = in.Name
	return nil
}

// Convert_v1alpha1_AllowlistItem_To_config_AllowlistItem is an autogenerated conversion function.
func Convert_v1alpha1_AllowlistItem_To_config_AllowlistItem(in *AllowlistItem, out *config.AllowlistItem, s conversion.Scope) error {
	return autoConvert_v1alpha1_AllowlistItem_To_config_AllowlistItem(in, out, s)
}

func autoConvert_config_AllowlistItem_To_v1alpha1_AllowlistItem(in *config.AllowlistItem, out *AllowlistItem, s conversion.Scope) error {
	out.Name = in.Name
	return nil
}

// Convert_config_AllowlistItem_To_v1alpha1_AllowlistItem is an autogenerated conversion function.
func Convert_config_AllowlistItem_To_v1alpha1_AllowlistItem(in *config.AllowlistItem, out *AllowlistItem, s conversion.Scope) error {
	return autoConvert_config_AllowlistItem_To_v1alpha1_AllowlistItem(in, out, s)
}
