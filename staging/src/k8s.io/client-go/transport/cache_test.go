...
func TestTLSConfigKey(t *testing.T) {
	...
	dialer := net.Dialer{}
	getCert := &GetCertHolder{GetCert: func(_ context.Context) (*tls.Certificate, error) { return nil, nil }}
	uniqueConfigurations := map[string]*Config{
		...
		"getCert2": {
			TLS: TLSConfig{
				KeyData:       []byte{1},
				GetCertHolder: &GetCertHolder{GetCert: func(_ context.Context) (*tls.Certificate, error) { return nil, nil }},
			},
		},
		"getCert1, key 2": {
			TLS: TLSConfig{
